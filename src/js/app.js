var fps           = 60;
//var spin = [new Audio("src/assets/sounds/reelsSound.mp3"),new Audio("src/assets/sounds/reelsSound.mp3"),new Audio("src/assets/sounds/reelsSound.mp3"),new Audio("src/assets/sounds/reelsSound.mp3"),new Audio("src/assets/sounds/reelsSound.mp3"),new Audio("src/assets/sounds/reelsSound.mp3"),new Audio("src/assets/sounds/reelsSound.mp3")];
window.raf = (function(){
